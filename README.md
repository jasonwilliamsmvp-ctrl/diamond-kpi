...
## v35 Sales CRM navigation

Sales users can open overview, customer management, daily performance and visit calendar from the sidebar. An account showing the first-login/password-reset warning must change its password and sign in again before business pages are available. Customer edits are restricted to the logged-in employee's own clinics. See `V35_CHANGELOG.md`.
